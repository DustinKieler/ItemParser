...
public class Item {
	...
	public static class ItemBuilder {
		 ...
		 * @return The current {@link Item} under construction.
		 */		
		public ItemBuilder shopPrice(int shopPrice) {
		 ...
		 * @return The current {@link Item} under construction.
		 */		
		public ItemBuilder lowAlchPrice(int lowAlchPrice) {
		 ...
		 * @return The current {@link Item} under construction.
		 */		
		public ItemBuilder highAlchPrice(int highAlchPrice) {
		 ...
		 * @return The current {@link Item} under construction.
		 */		
		public ItemBuilder itemBonuses(ItemBonuses bonuses) {
